...
def recieve_mes(message):
    ...
    if message.text == "/help":
        bot.send_message(message.chat.id, "Напиши мне название товара, если ты хочешь подписаться на обновления не забудь перед товаром написать (Узнать о поступлении)",reply_markup=prepare_reply_keyboard())
